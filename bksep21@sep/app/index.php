...
if(isset($_REQUEST['shopInstallation']) && !empty($_REQUEST['storeName'])){
  ...
  if($checkValid==''){
    ?> <script> window.location.href='https://<?php echo $_SERVER["HTTP_HOST"]; ?>/app/appInstall.php?shop=<?php echo strtolower($_REQUEST["storeName"]).".myshopify.com"; ?>'; </script> <?php
  } else {
...
<div class="container">
  ...
  <div class="col-md-12">
      ...
      <div class="col-md-6">
            <h3>Welcome to the Bleefs App.</h3>
